...
class ESPIDFParser:
    ...
    def __init__(self, kconfiglib_module):
        self.Kconfig = kconfiglib_module
    ...
    def parse_files(self, project_dir: str, kconfig_file: str):
        ...
        class KconfigParser(self.Kconfig):
            def __init__(self, filename):
                super().__init__(filename, parser_version=2)  # call init from parent Kconfig

        kconf = KconfigParser(str(kconfig_file_path))
